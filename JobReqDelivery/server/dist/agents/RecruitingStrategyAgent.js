...
export class RecruitingStrategyAgent {
    async validate(requisition, analyzerOutput, researcherOutput, recruiterOutput) {
        const result = await this.validateWithUsage(requisition, analyzerOutput, researcherOutput, recruiterOutput);
        return result.output;
    }
    async validateWithUsage(requisition, analyzerOutput, researcherOutput, recruiterOutput) {
        // 格式化必备能力（详细格式）
    ...
    ensureFitAssessment(assessment) {
    ...
    determineFinalVerdict(overallScore, providedVerdict) {
        // 如果提供了verdict且合理，使用它
...
//# sourceMappingURL=RecruitingStrategyAgent.js.map