...
export class RequirementsAnalyzer {
    async analyze(requisition) {
        const result = await this.analyzeWithUsage(requisition);
        return result.output;
    }
    async analyzeWithUsage(requisition) {
        ...
        try {
            ...
            const clarifyingQuestions = result.clarifyingQuestions.map(q => ({
                ...q,
                id: q.id || uuidv4(),
                isAnswered: false
            }));
...
//# sourceMappingURL=RequirementsAnalyzer.js.map